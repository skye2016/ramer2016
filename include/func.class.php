...
function GetNav($pid=1)
{
	...
	{    
        ...
        if($classname=="首页")
	    $str .= '<li class="page-scroll home"><a href="'.$gourl.'">'.$classname.'</a></li>';
		else 
		 $str .= '<li class="page-scroll"><a href="'.$gourl.'">'.$classname.'</a></li>';
  }
...
function GetNav1($pid)
{
	...
	{
		$classname = $row['classname'];
		$str .='<li class="filter" data-filter="'.$row['id'].'"> '.$classname.' </li>';
	}
